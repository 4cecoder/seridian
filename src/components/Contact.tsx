  ...
  return (
    <section id="contact" className="py-24" aria-labelledby="contact-heading">
      <div className="mx-auto max-w-6xl px-6">
        <div className="relative overflow-hidden rounded-2xl border border-seridian-500/20 bg-gradient-to-br from-slate-850 to-slate-925">
          ...
          <div className="relative grid gap-12 p-8 md:p-16 lg:grid-cols-2">
            <div>
              <p className="text-sm font-medium uppercase tracking-wider text-seridian-400">Contact</p>
              <h2 id="contact-heading" className="mt-3 text-3xl font-bold tracking-tight text-white md:text-4xl">
            ...
            <form className="space-y-5" onSubmit={handleSubmit} noValidate aria-describedby="contact-status">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-white/10 bg-slate-950/50 px-4 py-3 text-sm text-white placeholder:text-slate-600 focus:border-seridian-500/50 focus:outline-none focus:ring-1 focus:ring-seridian-500/50"
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={2000}
                  className="w-full resize-none rounded-lg border border-white/10 bg-slate-950/50 px-4 py-3 text-sm text-white placeholder:text-slate-600 focus:border-seridian-500/50 focus:outline-none focus:ring-1 focus:ring-seridian-500/50"
              ...
              <button
                ...
                disabled={loading}
                aria-busy={loading}
                className="w-full rounded-lg bg-seridian-500 px-6 py-3.5 text-sm font-semibold text-slate-950 transition-colors hover:bg-seridian-400 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {loading ? (
